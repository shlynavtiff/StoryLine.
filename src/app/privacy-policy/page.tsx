        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='mt-5'>
                ...
                <div className='mt-2'>
                    ...
                    <p className='pl-5 '>We may collect information about you from third-party services if you link your account to external platforms (e.g., social media or payment processors).</p>
                </div>
            </div>
